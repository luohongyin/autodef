local AdaLSTM, parent = torch.class("neuralconvo.AdaLSTM", "nn.LSTM")
...
AdaLSTM.usenngraph = false

function AdaLSTM:__init(inputSize, outputSize, rho)
...
function AdaLSTM:buildModel()
   ...
   self.o2g:add(nn.LinearNoBias(self.outputSize, 4*self.outputSize))
   self.o2g:add(nn.ConcatTable():add(nn.Sigmoid()):add(nn.Dropout(0)))
